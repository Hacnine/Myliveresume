...
const ResumeTab = () => {
                ...
                return (
                    ...
                    <div className=' gap-4 center  flex-col md:flex-row min-w-full'>
                        <div className=" bg-[#283240] w-fit p-4 rounded">
                            <p className=' text-yellow-500 text-sm font-semibold'>2009 - 2011</p>
    ...
    return (
        <div className="min-h-fit flex flex-wrap items-center justify-center bg-[#1a1d26] p-4">
            <div className=" p-6 rounded-md  max-w-full sm:max-w-6xl sm:min-h-[536px] w-full flex flex-col sm:flex-row">
