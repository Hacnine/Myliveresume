...
const ProjectShowcase = ({closeModal}) => {
    ...
    return (
        <div className=" bg-[#1e2026]  wrapper py-16 ">
            ...
            <motion.div
                ...
                className="bg-[#1f2a38] relative p-8 rounded-md container mx-auto shadow-lg    flex md:flex-row flex-col gap-3 items-center justify-center md:w-fit md:h-fit sc-456:w-[440px] sc-456:h-[640px] sc-456:overflow-y-clip overflow-y-scroll"
            >
